 ...
 *  using `this`.
 *
 *  This collection of functions are responsible for writing to the output 
 *  stream but should perform any formatting of the output string, their 
 *  role is to extract the relevant information call a format 
 *  function and write the result to the stream appending newlines where 
 *  necessary.
 *
 *  @module writers
 */
